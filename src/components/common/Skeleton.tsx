...
export const SkeletonCard: React.FC<{ className?: string }> = ({ className = '' }) => (
    <div className={`animate-pulse ${className}`}>
        <div className="card-glass gold-border rounded-2xl p-6 space-y-4">
...
export const SkeletonHero: React.FC = () => (
    <div className="min-h-screen flex flex-col items-center justify-center animate-pulse px-4">
        <div className="h-12 bg-white/5 rounded w-64 mb-6" />
        <div className="h-6 bg-white/5 rounded w-96 mb-3" />
...
export const SkeletonSection: React.FC<{ title?: string; cards?: number }> = ({ title, cards = 3 }) => (
    <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
            {title && <div className="text-center mb-12 animate-pulse"><div className="h-8 bg-white/5 rounded w-48 mx-auto mb-4" /><div className="h-1 bg-white/5 rounded w-20 mx-auto" /></div>}
