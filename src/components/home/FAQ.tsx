        ...
        >
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <p className="text-gray-500 leading-relaxed pb-8 text-lg md:text-xl">
                            {answer}
                        </p>
                    </motion.div>
                )}
            ...
            <div className="container mx-auto px-4 z-10 relative">
                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">我們尋找遵守 321A 原則的優質夥伴：</p>
                                <ul className="list-disc list-inside mb-4 space-y-2 text-gray-300">
                                    <li><strong className="text-[#333]">3</strong>：三年以上行業經驗</li>
                                    <li><strong className="text-[#333]">2</strong>：公司成立兩年以上</li>
                                    <li><strong className="text-[#333]">1</strong>：專注於一項主要專業 (單一產業別)</li>
                                    <li><strong className="text-[#333]">A</strong>：Attitude 態度良好，願意付出與學習</li>
                                </ul>
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">核心精神：</strong>確保每位會員都是該領域的專家，且在分會中尚無重複代表。
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">BNI有結構化的流程，不需要擔心社交技巧</p>
                                <p className="mb-4">每次例會都有固定流程：25秒專業介紹、5分鐘深度主講、分組交流。</p>
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">實際經驗：</strong>許多內向型會員反而在BNI找到舒適的交流方式，因為有明確的架構和目標。
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">每週三早晨實體聚會，結構化的高效商務交流</p>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">關鍵優勢：</strong>面對面的交流更能建立深度信任，長翔的夥伴們每週見面，信任感與默契與日俱增。
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">當來賓免費，流程簡單明確，無需複雜資料</p>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">貼心提醒：</strong>如果您確定要入會，我們將會進行資格審查，不保證一定能加入長翔
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">BNI提供彈性的代理人制度</p>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">重要提醒：</strong>為了維護會員權益，每位會員半年內缺席超過三次將可能被踢出，這是我們對夥伴彼此間的基本承諾。
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">BNI特別適合新創與個人工作者快速建立人脈</p>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">成功案例：</strong>李孟一在創業初期加入BNI，透過一對一快速鏈結教育產業鏈，並做為公司擴張基礎。
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">長翔是名人堂等級的白金分會，代表卓越的引薦實績</p>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">特別適合：</strong>渴望找到真心互助事業夥伴，並透過專業引薦拓展業務的企業主。
                                </div>
                            </>
                        }
                    />
                    <FAQItem
                        ...
                        answer={
                            <>
                                <p className="mb-3 text-[#CF2030] font-bold">BNI 是長期關係的投資，但許多夥伴在前幾個月就有感</p>
                                ...
                                <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-sm">
                                    <strong className="text-[#CF2030]">核心關鍵：</strong>付出越多，收穫越大。積極參與一對一、認真準備引薦，是加速成效的不二法門。
                                </div>
                            </>
                        }
                    />
